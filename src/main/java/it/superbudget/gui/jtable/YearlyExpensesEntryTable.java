...
public class YearlyExpensesEntryTable extends BudgetEntryTable
{

	public YearlyExpensesEntryTable(TableModel dm)
	{
		super(dm);
	...
	public void populate(Budget budget, Object... params)
	{
		...
		List<BudgetEntryView> budgets = budgetDao.getYearlyExpenses(budget, (Integer) params[0]);
